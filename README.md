...
At the Justus-Liebig-University of Giessen we used our Streaming-Server to serve these video streams.
...
```bash
mkdir -p public/Customizing/global/plugins/Modules/DataCollection/FieldTypeHook
cd public/Customizing/global/plugins/Modules/DataCollection/FieldTypeHook
